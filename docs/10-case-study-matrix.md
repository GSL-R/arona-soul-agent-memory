...
| Honesty scoring was satisfied by omission. | A rule can be gamed if it checks wording but not tool behavior. | Require verified search attempts for stronger confidence tiers. | Honesty tiers need behavioral prerequisites. | Only tool logs can prove whether an action was attempted. |
